...
import { normalizeRawUsageEvent } from './normalizeRawUsageEvent.js';
...
describe('normalizeRawUsageEvent', () => {
  ...
  it('maps Claude Code api error events into failed api request usage events', () => {
    const normalizedEvent = normalizeRawUsageEvent({
      ...
      attributes_event_name: 'claude_code.api_error',
      attributes_session_id: 'session-alpha',
      attributes_prompt_id: 'prompt-1',
      attributes_model: 'claude-sonnet-4',
      attributes_duration_ms: 900
    });
